...
if __name__ == "__main__":
    ...
    for i in range(5):
        print(
            create_pass(
                length=12, chars=True, upper=True, lower=True, numbers=True
            )
        )
    ...
    for i in range(5):
        print(
            create_pass(
                length=12, chars=True, upper=True, lower=False, numbers=True
            )
        )
    ...
    for i in range(5):
        print(
            create_pass(
                length=12, chars=True, upper=True, lower=False, numbers=False
            )
        )
    ...
    for i in range(5):
        print(
            create_pass(
                length=12, chars=False, upper=True, lower=False, numbers=False
            )
        )
